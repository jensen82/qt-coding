...
/**
 * @brief The QWindow class represents the window titlebar with the main widgets container. In the
...
class QWindow : public QWidget
{
    ...
    public:
        ...
        /**
         * @brief QWindow Main constructor that configures de UI with interal parameters.
         * @param parent The parent widget.
         */
        explicit QWindow(QWidget *parent = 0);
        /**
         * @brief QWindow destructor.
         */
        ~QWindow();
        /**
