...
void QWindow::mouseMoveEvent(QMouseEvent *e)
{
    int xMouse = e->pos().x();
    int yMouse = e->pos().y();
...
void QWindow::mousePressEvent(QMouseEvent *e)
{
...
void QWindow::mouseReleaseEvent(QMouseEvent *e)
{
    moveWidget = false;
    allowToResize = false;
    resizeVerSup = false;
...
void QWindow::mouseDoubleClickEvent(QMouseEvent *e)
{
...
void QWindow::moveWindow(QMouseEvent *e)
{
...
void QWindow::resizeWindow(QMouseEvent *e)
{
	if (allowToResize)
	{
		int xMouse = e->pos().x();
...
void QWindow::setCentralWidget(QWidget *widget, const QString &widgetName)
{
...
void QWindow::setTitlebarMode(const TitleMode &flag)
{
    m_titleMode = flag;
...
void QWindow::setTitlebarMenu(QMenu *menu, const QString &icon)
{
    ui->tbMenu->setMenu(menu);
    ui->tbMenu->setIcon(QIcon(icon));
}

void QWindow::maximizeBtnClicked()
{
...
void QWindow::minimizeBtnClicked()
{
    if (isMinimized())
    {
